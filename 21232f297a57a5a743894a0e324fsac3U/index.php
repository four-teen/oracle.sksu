...
<div class="app">
  ...
  <aside class="sidebar d-none d-lg-flex flex-column">
    ...
    <nav class="flex-grow-1">
      ...
      <a href="researches_analytics.php"><i class="bi bi-graph-up"></i><span>Program Analytics</span></a>
    ...
    <div class="container-fluid py-4">
      ...
      <div class="card-soft p-3 mb-3">
        <div class="d-flex flex-wrap gap-2 align-items-center">
          ...
          <button class="btn btn-success btn-sm" onclick="load_new_research()"><i class="bi bi-plus-circle"></i> Encode New Research</button>
...
<!--       <div class="row g-3 mb-3">
        <div class="col-lg-6">
          <div class="card-soft p-3 h-100">
            <div class="fw-semibold mb-2">By Type</div>
            <div class="d-flex align-items-center justify-content-between py-1 border-bottom"><span>Capstone</span><span class="badge text-bg-light">100</span></div>
        ...
        <div class="col-lg-6">
          <div class="card-soft p-3 h-100">
            ...
            <div class="mb-2">BSIT <div class="progress"><div class="progress-bar" style="width:100%"></div></div></div>
            <div class="mb-2">BSIS <div class="progress"><div class="progress-bar bg-success" style="width:35%"></div></div></div>
            <div class="mb-2">BSCS <div class="progress"><div class="progress-bar bg-warning" style="width:22%"></div></div></div>
...
<div class="modal fade" id="modalEdit" tabindex="-1">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header"><h5 class="modal-title"><i class="bi bi-plus-circle me-2"></i><span id="newModalTitle">Edit Research</span></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
      <div class="modal-body">
        <form id="frmResearchEdit" class="row g-3">
          ...
          <div class="col-12">
            <label class="form-label">Title</label>
            <textarea class="form-control" id="eTitle" rows="4" placeholder="Enter title…"></textarea>
          </div>
          <div class="col-md-4">
            <label class="form-label">Type</label>
